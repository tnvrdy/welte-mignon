      ...
      const MidiParser = {
        ...
        Uint8: function(FileAsUint8Array) {
          ...
          for (let t = 1; t <= MIDI.tracks; t++) {
            ...
            if (headerValidation !== 1297379947) return false;
            file.readInt(4);
            let e = 0;
            ...
            while (!endOfTrack) {
              ...
              if (statusByte === 255) {
                ...
                switch (MIDI.track[t - 1].event[e - 1].metaType) {
                  ...
                  // Lyrics)
                  case 7:
                  // Cue point                                         // Sequence/Track Name (documentation: http://www.ta7.de/txt/musik/musi0006.htm)
                  case 6:
